...
def get_one_voucher(customer, notification_type, voucher_name, voucher_validity, voucher_value, voucher_val_type, voucher_code, first_order_only, first_customer_order, pricelist_id):
