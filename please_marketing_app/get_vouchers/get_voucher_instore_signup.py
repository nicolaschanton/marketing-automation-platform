    ...
    try:
        ...
        params = {
                  ...
                  'data': {'name': voucher_name,                   # str Nom du coupon dans Odoo apparaît dans la ligne de commande
                           ...
                           'customer_id': customer_id,                      # int Id Odoo du client
                           ...
                           'pricelist_id': int(pricelist_id),           # int Id Odoo de l'offre ou False
        ...
        if (voucher_data[0].get("voucher_code") is not None) or (voucher_data[0].get("voucher_code") is not ""):
            ...
            return r_voucher_code, r_voucher_name, r_voucher_type, r_value, r_expiry_date, r_notification_type, r_pricelist_id

    except:
        print("ERROR: Failed to get voucher from Odoo for in store sign up campaign - " + str(sys.exc_info()))
